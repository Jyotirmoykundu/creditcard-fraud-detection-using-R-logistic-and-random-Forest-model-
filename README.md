...
### Logistic Regression
Trained a weighted logistic model using key PCA features (V1, V2, V3) and transaction amount.Optimized classification threshold (0.7) to improve fraud capture.
### Performance:
