...
### Logistic Regression
Trained a weighted logistic model using key PCA features (V1, V2, V3) and transaction amount.Optimized classification threshold (0.6) to improve fraud capture.
### Performance:
...
### Performance:
AUC–ROC: 0.956    Recall: 74.7%     Precision: 81.80%      
### Conclusion
