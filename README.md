...
### Metrics: Confusion Matrix, ROC–AUC, Recall, Precision.
...
### Logistic Regression
Trained a weighted logistic model using key PCA features (V1, V2, V3) and transaction amount.Optimized classification threshold (0.65) to improve fraud capture.
### Performance:
AUC–ROC: 0.929    Recall: 65.6%    Precision: 85 %   
### Random Forest
